...
<?php
    ...
    <div id="hl-cont" align="center">
        ...
        <div class="data-time-sql"></div>
        <div class="data-time-unix" style="padding-top: .5em;"></div>
...
<script>
   $.ajax({
     ...
     console.log( "Data Saved: " + resJson );
     $( ".data-time-sql" ).append( resJson.date_sql );
     $( ".data-time-unix" ).append( resJson.date_unix );
  });
</script>    
